...
train_filename=r'D:/Python/ML_Pro/machinelearning/MNIST_data/notMNIST_large.tar.gz'
test_filename =r'D:/Python/ML_Pro/machinelearning/MNIST_data/notMNIST_small.tar.gz'
